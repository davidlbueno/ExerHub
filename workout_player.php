...
<main class="container">
    ...
    if ($workoutId) {
      ...
      <a href='workout.php?workout_id=".urlencode($workoutId)."&workout_name=".urlencode($workoutName)."' class='player-close-btn'><i class='material-icons'>close</i></a>
